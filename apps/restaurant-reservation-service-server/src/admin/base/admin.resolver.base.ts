...
export class AdminResolverBase {
  ...
  async AdminApproveReservation(
    @graphql.Args()
    args: ReservationWhereUniqueInput
  ): Promise<Reservation> {
    return this.service.AdminApproveReservation(args);
  }
  ...
  async AdminDenyReservation(
    ...
    return this.service.AdminDenyReservation(args);
  }
  ...
  async ApproveReservation(
    ...
    return this.service.ApproveReservation(args);
  }
  ...
  async DenyReservation(
    ...
    return this.service.DenyReservation(args);
  }
}
